        ...
        <div class="main-content">
            <section class="section">
                <div class="section-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('ruangan.update', $ruangan->id) }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama" value="{{ old('nama', $ruangan->nama) }}"
                                            ...
                                            <div class="form-group col-md-4 mb-3">
                                                ...
                                                <select id="status"
                                                    ...
                                                    <option value="Tersedia"
                                                        {{ old('status', $ruangan->status) == 'Tersedia' ? 'selected' : '' }}>
                                                        Tersedia</option>
                                                    <option value="Tidak Tersedia"
                                                        {{ old('status', $ruangan->status) == 'Tidak Tersedia' ? 'selected' : '' }}>
