                            ...
                            @if ($pemesanan)
                                <div class="row">
                                    ...
                                    <div class="col-md-{{ $role == 'Mahasiswa' ? 4 : 6 }} detail-value">
                                        <span class="detail-header">
                                            Nama
                                            Pemesan{{ $role == 'Mahasiswa' ? ' || NPM' : ($role == 'Dosen' ? ' || NIP' : '') }}:
                                        </span>
                                        <p>
                                ...
                                <div class="row">
                                    <div class="col-md-6 detail-value">
                                        ...
                                        <p>{{ \Carbon\Carbon::parse($pemesanan->tanggal_pesan)->format('d/m/Y') ?? 'Tanggal tidak tersedia' }}
                                        </p>
                                    </div>
                                    <div class="col-md-6 detail-value">
                                        <span class="detail-header">Waktu Mulai - Waktu Selesai:</span>
                                        <p>{{ $pemesanan->waktu_mulai ?? '-' }} - {{ $pemesanan->waktu_selesai ?? '-' }}
                                        </p>
                                    </div>
                                </div>
